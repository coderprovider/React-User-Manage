...
const UserDetails = (props) => {
  ...
  const updateStreet = (e) => {
    props.onChange({
      ...props.user,
      address: { ...props.user.address, street: e.target.value },
    });
  };
  ...
  const updateZipCode = (e) => {
    props.onChange({
      ...props.user,
      address: { ...props.user.address, zipCode: e.target.value },
    });
  };
  ...
  const updateCity = (e) => {
    props.onChange({
      ...props.user,
      address: { ...props.user.address, city: e.target.value },
    });
  };
  ...
  const updateCountry = (e) => {
    props.onChange({
      ...props.user,
      address: { ...props.user.address, country: e.target.value },
    });
  };
      ...
      <div className="form-row">
        ...
        <div className="form-group col-md-5">
          ...
          <input
            ...
            className="form-control"
            id="inputCountry"
            value={props.user.address && props.user.address.country}
